...
import com.example.storage.bean.CommunicationUtil;
...
public class ContentResolverActivity extends AppCompatActivity implements OnClickListener{
    private final static String TAG = "ContentResolverActivity";
    ...
    private void showContactInfo() {
        try{
            ...
            mContactCount = String.format("当前共找到%d个联系人", count);
            tv_read_contact.setText(mContactResult);
        }catch(Exception e) {
