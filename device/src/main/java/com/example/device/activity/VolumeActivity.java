...
public class VolumeActivity extends AppCompatActivity implements OnSeekBarChangeListener, OnClickListener {
    ...
    private SeekBar sb_voice, sb_system, sb_ring, sb_music, sb_alarm, sb_notify;        //拖动条
    private ImageView iv_voice_add, iv_system_add, iv_ring_add, iv_music_add, iv_alarm_add, iv_notify_add;      //音量减
    private ImageView iv_voice_del, iv_system_del, iv_ring_del, iv_music_del, iv_alarm_del, iv_notify_del;      //音量加
    private int[] mStreamType = {
            AudioManager.STREAM_VOICE_CALL, AudioManager.STREAM_SYSTEM,
            AudioManager.STREAM_RING, AudioManager.STREAM_MUSIC,
            AudioManager.STREAM_ALARM, AudioManager.STREAM_NOTIFICATION};       //管理器类型
    private int[] mMaxVolume = {0, 0, 0, 0, 0, 0}; // 最大音量数组
    private int[] mNowVolume = {0, 0, 0, 0, 0, 0}; // 当前音量数组
    private SeekBar[] mSeekBar = {
            sb_voice, sb_system, sb_ring,
            sb_music, sb_alarm, sb_notify};     //拖动条数组
    ...
    private ImageView[] mAddView = {
            ...
            iv_music_add, iv_alarm_add, iv_notify_add};     //音量加数组
    private int[] mAddRes = {
    ...
    private ImageView[] mDelView = {
            ...
            iv_music_del, iv_alarm_del, iv_notify_del};     //音量减数组
    private int[] mDelRes = {
    ...
    public void onClick(View v) {
        int add_index = getArrayIndex(v.getId(), ADD_VIEW);      //音量加
        int del_index = getArrayIndex(v.getId(), DEL_VIEW);     //音量减
