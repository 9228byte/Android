    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_turn_view) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                Toast.makeText(MainActivity.this, "Android版本低于5.0无法使用camera2", Toast.LENGTH_SHORT).show();
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
                Toast.makeText(this, "计步器需要Android4.4或以上版本", Toast.LENGTH_SHORT);
            } else {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
                Toast.makeText(this, "红外遥控需要Android4.4以上版本", Toast.LENGTH_SHORT).show();
            } else {
